...
import { createNote, getNotes, updateNote, deleteNote, saveAudioNote, processAudioNote } from "../../controllers/note.controller.js";
...
router.post("/processAudioNote", processAudioNote);
