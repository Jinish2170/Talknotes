class AppConstants {
  ...
  static const String userProcessAudioNote =
      '/api/user/processAudioNote'; // Key endpoint
  ...
  static const int maxAudioFileSizeBytes =
      50 * 1024 * 1024; // 50MB (backend limit)
  ...
  static const String audioProcessingFailed =
      'Failed to process audio note. Please try again.';
  static const String fileTooBigError =
      'Audio file is too large. Maximum size is 50MB.';
  static const String unsupportedFormatError =
      'Unsupported audio format. Please use WAV, MP3, MP4, WebM, or OGG.';
  ...
  static const String audioProcessedSuccess =
      'Audio note processed successfully!';
  ...
  static const Duration longApiTimeout = Duration(
    minutes: 5,
